...
$sql = "INSERT INTO products (Prod_Name, Prod_Desc, Prod_Design, Design_Price, Pickup_Date, Quantity, Cust_ID, Height, Width) VALUES ('$valueName', '$valueDesc', '$valueDesign', '$valuePrice', '$valueDate', '$valueQuantity', '$custID','$valueHeight', '$valueWidth')";
